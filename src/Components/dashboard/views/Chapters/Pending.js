        ...
        {pendingChapters.length > 0 ? (
          pendingChapters.map((chapter) => (
            <>
              ...
              >
                <ModalHeader toggle={closeModal}>Delete Chapter</ModalHeader>
                <ModalBody>
              ...
              >
                ...
                <ModalBody>Would you like to approve this chapter?</ModalBody>
                <ModalFooter>
                  <Button
          ...
          pendingVolunteers.map((volunteer) => (
            <>
              ...
              <Modal
                ...
                className={props.className}
              >
                <ModalHeader toggle={closeModal}>Reject Request</ModalHeader>
                <ModalBody>
              ...
              >
                ...
                <ModalBody>Would you like to approve this request?</ModalBody>
                <ModalFooter>
                  <Button
                    className="affirm-btn"
                    onClick={() => {
