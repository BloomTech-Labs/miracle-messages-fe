          ...
          <div>
            <Autocomplete
              ...
              onChange={(event, chapter) => {
                if (chapter && mode === "chapters")
                  props.PinClickHandler(chapter);
              }}
              renderInput={(params) => (
                <TextField
                  {...params}
                  ...
                  variant="outlined"
                  placeholder={
                    mode === "chapters" ? "Search Chapters" : "Search Reunions"
                  }
                />
              )}
            />
            ...
            <Menu
              ...
              style={{ top: "60px" }}
            >
              <MenuItem onClick={() => changeSearchData("chapters")}>
                Chapters
              </MenuItem>
              <MenuItem onClick={() => changeSearchData("reunions")}>
                Reunions
              </MenuItem>
            </Menu>
          </div>
