...
const NewVolunteer = () => {
  ...
  const handleSubmit = () => {
    ...
    axios
      .post(
        "https://miracle-messages-dev.herokuapp.com/api/volunteer",
        volunteer
      )
      .then((res) => {
        console.log(res);
      ...
      <div className={classes.imageSide}>
        <div className={classes.imgContainer}>
          ...
          <img
            ...
            src={mmLogo}
            alt="Miracle Messages Logo"
          />
          {/* </div> */}
          <h3 className={classes.h3Styling}>
            Help us reconnect people with their loved ones.
          </h3>
        </div>
      </div>
          ...
          {steps.map((label, index) => {
            ...
            return (
              <Step key={label} {...stepProps}>
                <StepLabel className={classes.stepInner} {...labelProps}>
                  {label}
                </StepLabel>
              </Step>
            );
          ...
          <div className={classes.formContainer}>
            ...
            <div className={classes.buttonContainer}>
              {activeStep === steps.length - 1 ? (
                <a
                  target="_blank"
                  href="https://www.miraclemessages.org/faqs"
